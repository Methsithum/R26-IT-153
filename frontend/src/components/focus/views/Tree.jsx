...
export default function TabTree({ state, streak, focusMin, LEVEL_DATA: LD = LEVEL_DATA, challengePoints = 0, treeFx = null, treeFxNonce = 0 }) {
  ...
  return (
    <div className="fu-view space-y-4">
      ...
      <Card
        className="p-6 md:p-8 flex flex-col items-center relative overflow-hidden transition-all duration-700 fu-stagger"
        style={{
          "--fu-i": 0,
      ...
      >
        <div
          ...
          style={{ width: 280, height: 280, top: -36, left: "50%", transform: "translateX(-50%)", backgroundColor: cfg.color, opacity: 0.12 }}
        />
        ...
        <div className="text-center mt-2 relative">
          ...
          <p className="text-sm font-semibold mt-1.5 max-w-sm mx-auto leading-snug" style={{ color: cfg.color }}>
      ...
      <Card className="p-4 fu-stagger" style={{ "--fu-i": 1 }}>
        <SectionTitle title="Growth Journey" subtitle="Every level your tree can reach" className="mb-3" />
        <div className="relative">
          ...
          <div className="space-y-2.5">
            {LD.map((lvl, i) => {
              ...
              return (
                <div key={lvl.name} className="flex items-center gap-2.5 relative">
                  <span
                    className="w-7 h-7 rounded-full flex items-center justify-center text-xs shrink-0 relative z-10 transition-all"
                    style={{

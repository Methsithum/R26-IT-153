...
export default function BeforeAfterPanel({ before, after }) {
  ...
  if (!before || !after) {
    return (
      <section className="cp-panel">
        <h2 className="cp-panel-title">Before / After</h2>
        <p className="cp-placeholder">Run simulation to see changes</p>
      </section>
    );
  }
  ...
  return (
    <section className="cp-panel bap">
      <h2 className="cp-panel-title">Before / After</h2>
      ...
      <div className="bap-metric">
        ...
        <div className="bap-metric-row">
          ...
          <span
            className="bap-delta"
            style={{ color: scoreUp ? 'var(--green)' : scoreDelta < 0 ? 'var(--red)' : 'var(--text-faint)' }}
          >

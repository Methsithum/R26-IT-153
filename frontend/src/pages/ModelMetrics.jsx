...
export default function ModelMetrics() {
  ...
  // Fetch on mount. State updates happen in async continuations, not
  // synchronously in the effect body, so the cascading-render concern
  // behind this rule does not apply here.
  useEffect(() => {
  ...
  return (
    <div className="mm">
      ...
      <section className="cp-panel">
        <h2 className="cp-panel-title">Model A — Academic Risk Classification</h2>
      ...
      {/* Model B - regression */}
      <section className="cp-panel">
        <h2 className="cp-panel-title">Model B — Career Readiness Regression</h2>
        <div className="mm-scroll">
          <table className="mm-table">
            <thead>
              <tr>
      ...
      <section className="cp-panel mm-summary">
        <h2 className="cp-panel-title">Profile Validation Summary</h2>
